...
I will not go into significant detail about building the SmartiPi case and installing the Raspberry Pi touchscreen display as those details can be found on the [SmartiCase web site](https://smarticase.com/products/smartipi-touch-pro?variant=39297984790591).  Installing your Raspberry Pi of choice and the sensor carrier board on the rear of the case is done using the supplied screws.  You may want to attach the power adapter before installing the carrier board as it is significantly harder to do so with that installed. 
